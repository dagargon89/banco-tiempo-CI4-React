      ...
      <main className="mx-auto max-w-4xl px-4 py-6">
        ...
        <div className="overflow-hidden rounded-lg border border-border bg-surface shadow-sm">
          ...
          <div className="relative px-6 pb-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
              <StatCard label="Calificación" value="—" accent />
              <StatCard label="Actividades" value={0} />
              <StatCard label="Reseñas" value={0} />
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-5">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            {/* Skills */}
            <div>
              <h3 className="mb-3 text-sm font-semibold text-text-1">Habilidades que enseña</h3>
              <EmptyState
          ...
          <div className="space-y-6 lg:col-span-3">
            ...
            <div>
              ...
              <EmptyState
                ...
                subtitle="Tu historial aparecerá aquí cuando participes"
              />
            </div>

            {/* Reviews */}
            <div>
              <h3 className="mb-3 text-sm font-semibold text-text-1">Reseñas recibidas</h3>
              <EmptyState
                icon={<Star className="h-8 w-8" />}
                title="Sin reseñas aún"
                subtitle="Las reseñas aparecerán después de completar actividades"
              />
            </div>
          </div>
        </div>
